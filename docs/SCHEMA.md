...
| `submittedBy` | string | human | GitHub login of the person who added the app. Shown as "Submitted by @login" on the app page and listed on `/contributors/`. Validated by Grove (0.19+) as a GitHub login; a leading `@` is stripped. |
